    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader className="relative">
          <DialogTitle className="text-3xl font-bold text-sage-800 text-center font-handwritten mb-4">
            Privacy Policy
          </DialogTitle>
          <Button
            variant="ghost"
          ...
          <div className="text-sm text-sage-600 mb-6 text-center font-natural">
